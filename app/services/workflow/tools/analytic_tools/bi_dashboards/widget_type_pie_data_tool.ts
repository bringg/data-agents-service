...
export const widgetTypePieDataTool = tool(
	async input => {
		const url = `https://${process.env.REGION}-admin-api.bringg.com/analytics-service/v1/parent-app/own-fleet/dashboards/widget-type/${WidgetType.PieChart}/widgets-catalog-id/${input.widgetCatalogId}/get-data`;
